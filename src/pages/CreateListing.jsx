...
export default function CreateListing() {
  ...
  return (
    <main className='max-w-md px-2 mx-auto'>
        <h1 className='text-3xl text-center mt-6 font-weight-bold'>Create a Listing</h1>
        ...
        />
            ...
            <div className='flex'>
                <button type='button' id= "parking" onClick={onChange} value={true} className={`mr-3 px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg transition duration-150 ease-in-out w-full ${!parking ? "bg-white text-black" : "bg-slate-600 text-white"
                }`}>Yes</button>
            ...
            <div className='flex mb-6'>
              ...
              />
                        ...
                        <div className='w-full items-center justify-center'>
                            <p className='text-md w-full text-center justify-center items-center'>$ / Month</p>
                        </div>
